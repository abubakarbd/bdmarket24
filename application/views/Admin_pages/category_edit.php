  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <?php echo form_open_multipart('edit-category', 'class=form-horizontal');?>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
        	    ...
        	    <div class="input-group">
		        	...
		        	<input type="text" name="category_name"  class="form-control" id="i_name" value="<?php echo $category_id->category_name;?>">
	        	</div>
                     ...
                     <label class="control-label">Parent Category</label>
                        <select name="category_parent" id="i_month" class="form-control select2" style="width: 100%;">
            			  ...
            			  <?php foreach($activ_category as $category){ ?>
            			    <option
            			    <?php if($category->category_id == $category_id->category_id){?>
             ...
             <div class="col-md-10">
                ...
                <textarea id="editor1" name="category_description" rows="10" cols="80">
                    <?php echo $category_id->category_description;?>
                </textarea>
                </div>
                <div class="col-md-2 form-group group-mail">
                    <img src="<?php echo base_url(). $category_id->category_image;?>" width="70" height="70">
                    </div>
