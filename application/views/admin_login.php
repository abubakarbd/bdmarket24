...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>Admin</b>AS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>
    <p><?php if(isset($massage)){
					    echo $massage;
					}?></p>

    <?php echo form_open('admin_login/login_check');?>
      <div class="form-group has-feedback">
        <input type="text" name="admin_mobile" class="form-control" placeholder="Admin Info" required>
