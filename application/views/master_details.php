                ...
                <div class="container-fluid">
                    <div class="header-bottom-wrapper">
                        <div class="logo-2 furniture-logo ptb-30">
                            <a href="index.html">
                                <img src="<?php echo base_url();?>assets/img/logo/2.png" alt="">
                            </a>
                        </div>
                        ...
                        <div class="header-cart">
                            ...
                            <ul class="cart-dropdown">
                                ...
                                <li class="cart-btn-wrapper">
                                    <a class="cart-btn btn-hover" href="<?php echo base_url();?>cart">view cart</a>
                                    <a class="cart-btn btn-hover" href="<?php echo base_url();?>checkout">checkout</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="furniture-bottom-wrapper">
                        <div class="furniture-login">
                            <ul>
                                <li>Get Access: <a href="<?php echo base_url();?>login">Login </a></li>
                        ...
                        <div class="furniture-wishlist">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url();?>wishlist"><i class="ti-heart"></i> Wishlist</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
