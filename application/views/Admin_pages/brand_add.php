  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <?php echo form_open_multipart('brand-save', 'class=form-horizontal');?>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
        	    ...
        	    <div class="input-group">
		        	...
		        	<input type="text" name="brand_name" class="form-control" id="i_name" placeholder="Enter Brand Name">
	        	</div>
