 <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <?php echo form_open_multipart('edit-product', 'class=form-horizontal');?>
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
        		 ...
        		 <div class="input-group">
        			...
        			<input type="text" name="product_name" class="form-control" id="focusedinput" value="<?php echo $product_id->product_name;?>">
        		</div>
            ...
            <select name="product_brand" id="dob-day" class="form-control select2" style="width: 100%;">
    			  ...
    			  <?php foreach($activ_brand as $brand){?>
    			    <option
    			    <?php if($brand->brand_id == $product_id->product_brand){?>
            			    selected="selected" <?php }?>
    			    value="<?php echo $brand->brand_id;?>"><?php echo $brand->brand_name;?></option>
    			    <?php }?>
    		</select>
           </div>
            ...
            <select name="product_category" id="dob-day" class="form-control select2" style="width: 100%;">
    			  <option>Select Category</option>
    			    ...
    			    <option
    			    <?php if($category->category_id == $product_id->product_category){?>
            			    selected="selected" <?php }?>
 ...
 <div class="col-md-6">
   ...
   <div class="col-md-4 form-group group-mail">
         <label class="control-label">Regular price (৳ ) <span class="text-red">*</span> </label>
			...
			<input type="text" name="product_rprice" class="form-control" id="focusedinput" value="<?php echo $product_id->product_rprice;?>">
		</div>
   </div>
   ...
   <div class="col-md-4 form-group group-mail">
         <label class="control-label">Sale price (৳ ) <span class="text-red">*</span></label>
			...
			<input type="text" name="product_price" class="form-control" id="focusedinput" value="<?php echo $product_id->product_price;?>">
		</div>
       ...
       <div class="col-md-4 form-group group-mail">
		 ...
		 <div class="input-group">
			...
			<input type="text" name="product_qit" class="form-control" id="focusedinput" value="<?php echo $product_id->product_qit;?>">
		</div>
   </div>
        ...
        <div class="input-group">
           ...
           <div class="col-md-12">
               ...
               <div class="col-md-10">
                  ...
                  <textarea name="product_short_desc" class="form-control" rows="3" placeholder="Enter ...">
                      <?php echo $product_id->product_short_desc;?>
                  </textarea>
                </div>
            </div>
            <div class="col-md-2">
                <img src="<?php echo base_url(). $product_id->product_image;?>" width="50" height="50">
            </div>
                <div class="col-md-12">
                <label class="control-label">Long Description</label>
                <textarea id="editor1" name="product_long_desc" rows="10" cols="80">
                    <?php echo $product_id->product_long_desc;?>
                </textarea>
            </div>
